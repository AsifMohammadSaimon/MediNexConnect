...
// FIX: was ?delete_all (no value), now ?delete_all=1
...
if(isset($_POST['update_qty'])){
   ...
   $p_qty   = max(1, (int)$_POST['p_qty']); // FIX: cast to int, minimum 1
...
<section class="shopping-cart">
   ...
   <form action="" method="POST" class="box">
      <a href="cart.php?delete=<?= $fetch_cart['id']; ?>" class="fas fa-times" onclick="return confirm('Delete this item from cart?');"></a>
      <!-- FIX: was href=".php?pid=..." (broken) -->
   ...
   <div class="cart-total">
      ...
      <!-- FIX: was ?delete_all (no value, never triggered) -->
      <a href="cart.php?delete_all=1" class="delete-btn <?= ($grand_total > 0)?'':'disabled'; ?>">delete all</a>
